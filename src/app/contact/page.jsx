          ...
          <section className="flex min-w-0 flex-col justify-center text-center lg:text-left">
            ...
            >
              ...
              <div className="group rounded-xl border border-slate-200 bg-white/80 p-2 text-left shadow-[0_8px_25px_rgba(15,23,42,0.05)] backdrop-blur-md transition-all duration-300 hover:-translate-y-1 hover:border-violet-200 hover:shadow-[0_12px_30px_rgba(124,58,237,0.1)] sm:rounded-2xl sm:p-3.5">
                ...
                <p className="text-[9px] font-bold text-slate-900 sm:text-xs">
                  Web Developer
                </p>

                <p className="mt-0.5 text-[7px] leading-3 text-slate-500 sm:text-[10px] sm:leading-4">
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <div className="mb-3 sm:mb-5">
                  ...
                  <h2 className="mt-1 text-lg font-bold tracking-tight text-slate-900 sm:text-2xl md:text-3xl">
                    Let&apos;s talk.
                  </h2>

                  <p className="mt-1 text-[9px] leading-3.5 text-slate-500 sm:text-xs sm:leading-5">
                ...
                <div className="mb-2.5 sm:mb-4">
                  <label
                    htmlFor="user_name"
                    className="mb-1 block text-[9px] font-semibold text-slate-800 sm:text-xs"
                  >
                    Your name
                  </label>
