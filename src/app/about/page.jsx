    ...
    >
      ...
      >
        ...
        <div className="pointer-events-none fixed inset-0 -z-10 overflow-hidden">
          <div className="absolute -left-40 top-20 h-72 w-72 rounded-full bg-violet-500/5 blur-3xl" />

          <div className="absolute right-0 top-1/3 h-96 w-96 rounded-full bg-cyan-400/5 blur-3xl" />

          <div className="absolute bottom-0 left-1/3 h-80 w-80 rounded-full bg-indigo-500/5 blur-3xl" />

          <div className="absolute left-1/2 top-1/2 h-64 w-64 -translate-x-1/2 rounded-full bg-purple-400/5 blur-3xl" />
        </div>
        ...
        <div className="min-h-full lg:flex">
          ...
          <div className="flex w-full flex-col gap-28 px-5 py-20 sm:gap-32 sm:px-8 sm:py-24 md:gap-36 md:px-12 md:py-28 lg:w-2/3 lg:gap-44 lg:px-16 lg:py-32 xl:w-1/2 xl:px-24 2xl:px-32">
            ...
            <section className="flex flex-col gap-10 sm:gap-12">
              ...
              >
                <div className="absolute -inset-4 rounded-full bg-gradient-to-r from-violet-500 via-indigo-500 to-cyan-400 opacity-20 blur-xl transition-all duration-500 group-hover:opacity-50" />
              ...
              >
                <h1 className="group relative w-fit text-2xl font-bold tracking-tight sm:text-3xl">
                  ...
                  <span className="absolute -bottom-2 left-0 h-[2px] w-0 rounded-full bg-gradient-to-r from-violet-600 to-cyan-400 transition-all duration-500 group-hover:w-full" />
                </h1>

                <div className="mt-4 h-1 w-12 rounded-full bg-gradient-to-r from-violet-600 to-cyan-400" />
              </motion.div>
              ...
              <motion.div
                ...
                className="group relative overflow-hidden rounded-2xl border border-violet-100 bg-gradient-to-br from-violet-50 via-white to-cyan-50 p-5 shadow-sm transition-all duration-300 hover:border-violet-200 hover:shadow-[0_15px_40px_rgba(124,58,237,0.1)] sm:p-6"
              >
                <div className="absolute left-0 top-0 h-full w-1 bg-gradient-to-b from-violet-600 via-indigo-500 to-cyan-400" />
              ...
              <motion.div
                ...
                className="relative max-w-xl overflow-hidden rounded-2xl border border-violet-100 bg-gradient-to-r from-violet-50 via-white to-cyan-50 p-5 shadow-sm transition-all duration-300 hover:border-violet-200 hover:shadow-[0_15px_40px_rgba(124,58,237,0.1)]"
              >
                <div className="absolute left-0 top-0 h-full w-1 bg-gradient-to-b from-violet-600 via-indigo-500 to-cyan-400" />
            ...
            >
                  ...
                  return (
                    <motion.button
                      ...
                      className={`group relative overflow-hidden rounded-xl border px-4 py-2.5 text-sm font-medium transition-all duration-300 ${
                        isSelected
                          ? "border-violet-400 bg-violet-50 text-violet-700 shadow-[0_10px_30px_rgba(124,58,237,0.18)]"
                          : "border-neutral-200 bg-white text-neutral-700 shadow-sm hover:border-violet-300 hover:text-violet-700 hover:shadow-[0_10px_30px_rgba(124,58,237,0.15)]"
                      }`}
                    >
                      <span className="absolute inset-0 scale-0 rounded-xl bg-gradient-to-r from-violet-500/10 via-indigo-500/10 to-cyan-400/10 transition-transform duration-300 group-hover:scale-100" />
              ...
              {selectedSkill && (
                <motion.div
                  ...
                  className="relative max-w-2xl overflow-hidden rounded-2xl border border-violet-200 bg-white p-6 shadow-[0_20px_50px_rgba(124,58,237,0.12)] sm:p-7"
                >
                  <div className="absolute left-0 top-0 h-full w-1 bg-gradient-to-b from-violet-600 via-indigo-500 to-cyan-400" />
                  ...
                  <div className="flex items-start justify-between gap-4">
                    ...
                    <div>
                      <span className="inline-flex rounded-full bg-gradient-to-r from-violet-100 to-indigo-100 px-3 py-1 text-xs font-semibold text-violet-700">
                    ...
                    <button
                      ...
                      className="flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-neutral-100 text-lg text-neutral-500 transition-all hover:rotate-90 hover:bg-violet-100 hover:text-violet-700"
                    >
                      ×
                    </button>
                  ...
                  <div className="mt-5 rounded-xl bg-gradient-to-r from-violet-50 via-white to-cyan-50 p-4">
            ...
            >
              ...
              >
                ...
                <div className="absolute bottom-0 left-1/2 top-0 hidden w-[2px] -translate-x-1/2 rounded-full bg-gradient-to-b from-violet-500 via-indigo-500 to-cyan-400 md:block" />
                ...
                <div className="flex flex-col gap-8 md:gap-0">
                  ...
                  {journey.map((item) => (
                    <div
                      key={item.title}
                      className="relative flex flex-col md:min-h-[230px] md:flex-row md:items-start"
                    >
                      ...
                      <div className="hidden w-2/12 justify-center md:flex">
                        <div className="relative z-10">
                          <motion.div
                            ...
                            className="h-5 w-5 rounded-full border-4 border-white bg-gradient-to-r from-violet-600 to-indigo-500 shadow-[0_0_20px_rgba(124,58,237,0.45)]"
                          />
                        </div>
                      </div>
  ...
  return (
    ...
    >
      <svg
        ...
        width={42}
        height={42}
        className="drop-shadow-[0_0_10px_rgba(124,58,237,0.2)]"
      >
        <path
...
const JourneyCard = ({ item }) => {
  return (
    <motion.div
      ...
      className="group relative overflow-hidden rounded-2xl border border-neutral-200 bg-white p-5 shadow-sm transition-all duration-300 hover:border-violet-200 hover:shadow-[0_15px_45px_rgba(124,58,237,0.12)] sm:p-6"
    >
      ...
      <h3 className="relative z-10 text-base font-semibold text-neutral-900 transition-colors duration-300 group-hover:text-violet-700 sm:text-lg">
        {item.title}
      </h3>

      <p className="relative z-10 mt-3 text-sm leading-7 text-neutral-500">
        {item.description}
      </p>
      ...
      <span className="relative z-10 mt-3 inline-block rounded-lg bg-neutral-100 px-3 py-1.5 text-xs font-medium text-neutral-600 transition-colors duration-300 group-hover:bg-violet-50 group-hover:text-violet-700">
        {item.category}
      </span>

      <div className="absolute bottom-0 left-0 h-[2px] w-0 bg-gradient-to-r from-violet-600 via-indigo-500 to-cyan-400 transition-all duration-500 group-hover:w-full" />
    </motion.div>
  );
};
